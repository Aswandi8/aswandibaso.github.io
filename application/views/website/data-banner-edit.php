<div class="min-height-200px">
            ...
            <div class="col-md-6 col-sm-12">
                ...
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('website/banner'); ?>">Data Banner</a></li>
    ...
    <div class="card-box mb-30">
        ...
        <div class="pd-20">
            <?php foreach ($editDataBanner as $dm) : ?>
                <?= form_open_multipart('website/edit-banner/' . $dm['slug_title']); ?>
                <input type="hidden" id="id" name="id" value="<?= $dm['id']; ?>">
                <input type="text" id="old_image" name="old_image" value="<?= $dm['image']; ?>">
                <div class="row">
                    <div class="col-md-4">
                        <img src="<?= base_url('assets/img/landingpage/' . $dm['image']); ?>" alt="">
                    </div>
                    <div class="col-md-8">
