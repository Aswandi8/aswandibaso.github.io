    ...
    <div class="card-box mb-30">
            ...
            <div class="modal fade" id="Medium-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <?= form_open_multipart('website/banner'); ?>
        ...
        <div class="">
            <table class="data-table table stripe hover nowrap">
                <thead>
                    <tr>
                        <th class="table-plus datatable-nosort">Active?</th>
                        <th>Title</th>
                        <th>Slug</th>
                ...
                <tbody>
                    <?php $i = 1; ?>
                    <?php foreach ($getDataBanner as $m) : ?>
                        <tr>
                            <td class="table-plus">
                                <div class="form-check">
                                    <input type="checkbox" class="bannerChangeActive" value="<?= $m['id']; ?>" <?php if ($m['is_active'] == 1) echo "checked='checked'"; ?> data-toggle="checkbox">
                                </div>
                            </td>
                            <td class="table-plus">
                                <div class="name-avatar d-flex align-items-center">
                                    <div class="avatar mr-2 flex-shrink-0">
                                        <img src="<?= base_url('assets/img/landingpage/' . $m['image']); ?>" class=" shadow" width="40" height="40" alt="">
                                    </div>
                                    <div class="txt">
                            ...
                            <td>
                                <a class="" href="<?= base_url('website/edit-banner/' . $m['slug_title']); ?>"><i class="dw dw-edit2 text-indigo"></i></a>
                                <a class="" href="<?= base_url('website/deletebanner/' . $m['slug_title']); ?>"><i class="dw dw-delete-3 text-danger"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
