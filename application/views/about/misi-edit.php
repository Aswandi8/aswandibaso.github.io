<div class="min-height-200px">
            ...
            <div class="col-md-6 col-sm-12">
                ...
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('about/misi-kbm'); ?>">Misi KBM</a></li>
    ...
    <div class="card-box mb-30">
        ...
        <div class="pd-20">
            <?php foreach ($editMisi as $dm) : ?>
                <?= form_open_multipart('about/edit-misi-kbm/' . $dm['slug_misi']); ?>
                <input type="hidden" id="id" name="id" value="<?= $dm['id']; ?>">
                <div class="form-group row">
                    <label class="col-sm-12 col-md-2 col-form-label">Title</label>
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control" type="text" id="misi" name="misi" value="<?= $dm['misi']; ?>">
