    ...
    <div class="card-box mb-30">
            ...
            <div class="modal fade" id="Medium-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form action="<?= base_url('about/visi-kbm'); ?>" method="post">
        ...
        <div class="">
            <table class="data-table table stripe hover nowrap">
                ...
                <tbody>
                    <?php $i = 1; ?>
                    <?php foreach ($dataVisi as $m) : ?>
                        <tr>
                            <td class="table-plus"><?= $i++; ?></td>
                            <td>
                                <div class="weight-600"><?= substr($m['visi'], 0, 130); ?></div>
                            </td>
                            <td>
                                <a class="" href="<?= base_url('about/edit-visi-kbm/' . $m['slug_visi']); ?>"><i class="dw dw-edit2 text-indigo"></i></a>
                                <a class="" href="<?= base_url('about/deleteVIsi/' . $m['slug_visi']); ?>"><i class="dw dw-delete-3 text-danger"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
