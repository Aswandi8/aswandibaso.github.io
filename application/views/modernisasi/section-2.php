    ...
    <div class="card-box mb-30">
            ...
            <div class="modal fade" id="Medium-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form action="<?= base_url('modernisasi/section-2'); ?>" method="post">
        ...
        <div class="">
            <table class="data-table table stripe hover nowrap">
                ...
                <tbody>
                    <?php $i = 1; ?>
                    <?php foreach ($ModernisasiSection2 as $m) : ?>
                        <tr>
                            ...
                            <td>
                                <a class="" href="<?= base_url('modernisasi/edit-section-2/' . $m['slug_title']); ?>"><i class="dw dw-edit2 text-indigo"></i></a>
                                <a class="" href="<?= base_url('modernisasi/deleteSection2/' . $m['slug_title']); ?>"><i class="dw dw-delete-3 text-danger"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
