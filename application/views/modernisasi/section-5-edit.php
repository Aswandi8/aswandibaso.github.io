<div class="min-height-200px">
            ...
            <div class="col-md-6 col-sm-12">
                ...
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('modernisasi/section-5'); ?>">Data Section 5</a></li>
    ...
    <div class="card-box mb-30">
        ...
        <div class="pd-20">
            <?php foreach ($dataSection5 as $dm) : ?>
                <?= form_open_multipart('modernisasi/edit-section-5/' . $dm['slug_title']); ?>
