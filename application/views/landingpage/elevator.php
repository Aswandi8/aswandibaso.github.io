<main id="main">
    ...
    <section class="service-details">
        <div class="container">
            <div class="row">
                <?php foreach ($getAllElevator as $gae) : ?>
                    <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"><a href="<?= base_url('id/product/elevator/' . $gae['slug_name']); ?>"><?= $gae['name']; ?></a></h5>
                                <p class="card-text">Elevator - <?= $gae['title']; ?></p>
                                <p class="card-text"><?= $gae['keterangan']; ?></p>
                                <div class="read-more"><a href="<?= base_url('id/product/elevator/' . $gae['slug_name']); ?>"><i class="bi bi-arrow-right"></i> Read More</a></div>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
