<div class="min-height-200px">
            ...
            <div class="col-md-6 col-sm-12">
                ...
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('maintenance/section-2'); ?>">Data Section 2</a></li>
    ...
    <div class="card-box mb-30">
        ...
        <div class="pd-20">
            <?php foreach ($dataSection2 as $dm) : ?>
                <?= form_open_multipart('maintenance/edit-section-2/' . $dm['slug_title']); ?>
