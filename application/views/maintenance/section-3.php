    ...
    <div class="card-box mb-30">
            ...
            <div class="modal fade" id="Medium-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <?= form_open_multipart('maintenance/section-3'); ?>
        ...
        <div class="">
            <table class="data-table table stripe hover nowrap">
                ...
                <tbody>
                    <?php $i = 1; ?>
                    <?php foreach ($MaintenanceSection3 as $m) : ?>
                        <tr>
                            <td>
                                <div class="name-avatar d-flex align-items-center">
                                    <div class="avatar mr-2 flex-shrink-0">
                                        <img src="<?= base_url('assets/img/maintenance/' . $m['image']); ?>" class=" shadow" width="60" alt="">
                                    </div>
                                </div>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="weight-600"><?= substr($m['sub_title'], 0, 20); ?>...</div>
                            </td>
                            <td>
                                <div class="weight-600"><?= substr($m['keterangan'], 0, 60); ?>...</div>
                            </td>
                            <td>
                                <a class="" href="<?= base_url('maintenance/edit-section-3/' . $m['slug_title']); ?>"><i class="dw dw-edit2 text-indigo"></i></a>
                                <a class="" href="<?= base_url('maintenance/deleteSection3/' . $m['slug_title']); ?>"><i class="dw dw-delete-3 text-danger"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
