<div class="min-height-200px">
            ...
            <div class="col-md-6 col-sm-12">
                ...
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('maintenance/section-3'); ?>">Data Section 3</a></li>
    ...
    <div class="card-box mb-30">
        ...
        <div class="pd-20">
            <?php foreach ($dataSection3 as $dm) : ?>
                <?= form_open_multipart('maintenance/edit-section-3/' . $dm['slug_title']); ?>
                <input type="hidden" id="id" name="id" value="<?= $dm['id']; ?>">
                <input type="hidden" id="old_image" name="old_image" value="<?= $dm['image']; ?>">
                <div class="row">
                    <div class="col-md-4">
                        <img src="<?= base_url('assets/img/maintenance/' . $dm['image']); ?>" alt="">
                    </div>
                    <div class="col-md-8">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="text" id="sub_title" name="sub_title" value="<?= $dm['sub_title']; ?>">
